...
def iris_probabilistic_decision_tree_viz(depth):
    ...
    tab0, tab1, tab2, tab4, tab5 = st.tabs(
        ["User Prediction", "Confusion-Matrix", "Evaluation-Metrics", "Iris PDT Visualization", "Custom Insights"])
    ...
    with tab5:
        ...
        if 'tree_screenshot_dt_iris' not in st.session_state:
            st.session_state['tree_screenshot_dt_iris'] = None
        ...
        if st.session_state['show_tree_canvas_pdt_iris']:
            ...
            with tree_container:
                ...
                st.session_state.canvas_state_dt_iris = streamlit_flow(
                    key='fully_interactive_flow_iris',
            ...
            if st.session_state['tree_screenshot_dt_iris'] is not None:
                col2.download_button(
                    label="Download Tree Image",
                    data=st.session_state['tree_screenshot_dt_iris'],
